...
const CACHE = 'obras-v35';
const ASSETS = ['./', './index.html', './app.js', './share.js', './ui-confirm.js', './privacidade.html', './auth.js', './globe.js', './calc.js', './cloud.js', './icons.js', './splash.js', './splash-pre.js', './teclado.js', './tema.js', './pwa.js', './manifest.json', './icon.svg', './icon-192.png', './icon-512.png', './fontes/hanken-grotesk-800.woff2'];
