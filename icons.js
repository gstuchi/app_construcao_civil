...
(function(root){
  const ICONES = {
    ...
    ladrilho:   '<rect x="3" y="3" width="18" height="18" rx="2"/><path d="M3 12h18M12 3v18"/>',
    vergalhao:  '<path d="M5 4v16M12 4v16M19 4v16"/><path d="M2 9h20M2 15h20"/>',
    piscina:    '<path d="M7 14V5a2 2 0 0 1 4 0M15 14V5a2 2 0 0 1 4 0"/><path d="M7 9h4M15 9h4"/><path d="M2 15c1.7 0 1.7 1.5 3.3 1.5S7 15 8.7 15s1.6 1.5 3.3 1.5S13.7 15 15.3 15s1.7 1.5 3.4 1.5S20.3 15 22 15"/><path d="M2 19.5c1.7 0 1.7 1.5 3.3 1.5S7 19.5 8.7 19.5s1.6 1.5 3.3 1.5 1.7-1.5 3.3-1.5 1.7 1.5 3.4 1.5 1.6-1.5 3.3-1.5"/>',
